<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rConfiguraciones.aspx.cs" Inherits="FacSisEnero.Form.rConfiguraciones" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card card-register mx-auto mt-5">
        <div class="card-header text-uppercase text-center text-primary">Registro Configuraciones</div>
        <div class="card-body">
            <div class="form-row justify-content-center">
                <div class="form-group col-md-2">
                    <asp:Label Text="Configuraciones Id" class="text-primary" runat="server" />
                    <asp:TextBox ID="ConfiguracionesIdTextBox" class="form-control input-group" TextMode="Number" placeholder="0" runat="server" />
                </div>
            ...
            <div class="form-row justify-content-center">
                <div class="form-group col-md-3">
                    <asp:Label Text="NCF" runat="server" />
                    <asp:TextBox ID="NCFTextBox" class="form-control input-sm" runat="server"></asp:TextBox>
                </div>
            </div>
        </div>
